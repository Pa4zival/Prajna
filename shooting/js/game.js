...
GAME.Init = function() {
	...
	GAME.preload = {};
	GAME.preload.player = new Mibbu.spr('img/player.png', 40, 40, 0, 1),
	GAME.preload.enemy = new Mibbu.spr('img/enemies.png', 30, 30, 1, 2),
	GAME.preload.explosion = new Mibbu.spr('img/explosion.png', 30, 30, 0, 3),
	GAME.preload.background = new Mibbu.bg('img/bg1.jpg', 6, 90, {x:0,y:0});

	GAME.keyboard = new GAME.Input();
	GAME.$id('menu-start').onclick = function() { GAME.Menu('game', GAME.preload); };
